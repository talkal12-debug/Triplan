    ...
    <div>
      <label className="relative block">
        ...
        <input
          ...
          autoComplete="off"
          className="h-12 w-full rounded-md border border-input bg-card ps-11 pe-4 text-base shadow-xs outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
        />
      </label>
