...
| 13 | 🔄 בתהליך | 2026-09-06 | `milestone-13-deploy` | Prisma ל-PostgreSQL, `vercel.json`, `docs/deploy.md`, branch `main`. ממתין לטל: יצירת repository ב-GitHub, חשבון Vercel, Neon, הדבקת `AUTH_SECRET` |
