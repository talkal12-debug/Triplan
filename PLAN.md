...
59. **קישורי הזמנה (9):** כל קישור הוא deep link לחיפוש באתר השותף עם העיר (בשם האנגלי, כי החיפוש של האתרים לא מבין עברית), התאריכים, מספר המבוגרים וגילאי הילדים. טיסות: מעיר המוצא שהמטייל הזין בשלב התאריכים, ובלי הזנה מתל אביב לממשק העברי ("anywhere" בשאר השפות). השכרת רכב (Rentalcars, Discover Cars) מופיעה רק כשבחרו רכב בתחבורה, איסוף בעיר הראשונה והחזרה באחרונה. מבנה הכתובות של Rentalcars ו-Discover Cars נבנה לפי הכתובות הציבוריות ולא אומת מול חשבון שותף.
